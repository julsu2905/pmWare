...
const HomeContent = () => {
  ...
  const Demo = () => (
    <>
      <Avatar.Group className="group-user">
        ...
        />
        <Avatar className="user-A" style={{ backgroundColor: "#f56a00" }}>
          K
        </Avatar>
  ...
  function showDeleteConfirm(project) {
    confirm({
      ...
      onOk() {
        axios
          .delete(`http://127.0.0.1:9696/api/project/${project._id}`)
          .then((res) => {
  ...
  return (
    <>
      ...
      <Row>
        <Col offset={9}>
          <h1 className="project-title">Your Project</h1>
        </Col>
      </Row>
      <Row>
        <Col offset={2} span={22}>
          <Row>
            {projects.length > 0 ? (
              ...
              <Row>
                <Col offset={5}>
                  <Title level={3}>
                    You have not participated in any project yet.
                  </Title>
                </Col>
              </Row>
            )}
          ...
          {projects.length > 0 ? (
            <Row>
              <Col offset={9}>
                <button className="btn-load" onClick={showMoreItem}>
                  Load More
                </button>
              </Col>
            </Row>
